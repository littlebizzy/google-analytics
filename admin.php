...
class GASLBZ_Admin {
	...
	public static function admin_menu() {
		add_submenu_page('options-general.php', 'Google Analytics', 'Google Analytics', 'manage_options', 'ga-littlebizzy', array(__CLASS__, 'admin_page'));
	}
	...
	public static function admin_page() {
		...
		?><div class="wrap">
			...
			<form method="post" style="padding-top: 5px;">
				...
				<?php if (isset($success)) : ?><div class="notice notice-success"><p>Data saved successfully. Please <strong>remove your cached pages</strong> if you are using a caching plugin.</p></div><?php endif; ?>
